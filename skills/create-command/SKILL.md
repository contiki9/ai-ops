...
2. **Command Structure and Style**
   ...
   - **Language**: The `description` in the YAML frontmatter MUST be written in Japanese. However, the AI instructions (the body of the command) MUST be written in English. The outputs generated by the command should default to Japanese adhering to the project's global rules (`AGENTS.md`), unless specified otherwise.
